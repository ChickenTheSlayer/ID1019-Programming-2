defmodule Day16a do
  ...
  def dynamic(t) do
    ...
    valves = Enum.map(map, fn({valve,_}) -> valve end) #create a list of non-zero valves
  ...
  #calculate max flow rate of current valve
  def search(valve, t, valves, open, rate, map, mem, path) do
    ...
    #select the tunnel that gives the greatest max flow rate
